...
if ENV == 'dev':
    ...
    app.debug = False
    app.config['SQLALCHEMY_DATABASE_URI'] = ' postgres://gkyaaaqwynepog:3ae158041cfe604b50c65d7ca8c85aa0e546369ae30d96916dc124cc3d1f8782@ec2-54-235-86-101.compute-1.amazonaws.com:5432/d2kpgamq13u6p9'
